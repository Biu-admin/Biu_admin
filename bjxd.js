...
捉域名bm2-api.bluemembers.com.cn任意包的token填到bjxdCookie里，多账户用&隔开
    ...
    async ask_info() {
        ...
        try {
            let _0x2a7cc6 = {
                ...
                queryParam: { date: _0x8716db.time("yyyyMMdd") }
            };
...
function _0x5783c6() {
    ...
    console.log("=======频道：https://pd.qq.com/s/672fku8ge    QQ3288588344=======");
...
async function _0x521f1c(_0x263b8f, _0x513b4c) {
    return new Promise(_0x40a2b3 => {
        _0x8716db.send(_0x263b8f, _0x513b4c, async (_0x6e577d, _0x129293, _0xf085c6) => {
            const _0x348782 = { err: _0x6e577d, req: _0x129293, resp: _0xf085c6 };
            _0x40a2b3(_0x348782);
        });
    });
}
        ...
        send(_0x30ed81, _0x46cad7, _0x1cc856 = () => { }) {
            ...
            if (this.isSurge() || this.isLoon()) {
                if (this.isSurge() && this.isNeedRewrite) {
                    ...
                    const _0x26fc4f = { "X-Surge-Skip-Scripting": !1 };
                ...
                $axios(_0x3a24fc).then(_0x5bd58f => {
                    const { status: _0x170536, request: _0x1e7cb3, headers: _0x468f75, data: _0x580b03 } = _0x5bd58f,
                        _0x571f3c = { statusCode: _0x170536, headers: _0x468f75, body: _0x580b03 };
                    _0x1cc856(null, _0x1e7cb3, _0x571f3c);
                }).catch(_0x4bda4a => console.log(_0x4bda4a));
            } else {
                if (this.isQuanX()) {
                    const _0x327740 = { hints: !1 };
                    ...
                    $task.fetch(_0x46cad7).then(_0x54076a => {
                        const { statusCode: _0x1a879b, request: _0x425de9, headers: _0x3d8419, body: _0x40f74b } = _0x54076a,
                            _0x206c23 = { statusCode: _0x1a879b, headers: _0x3d8419, body: _0x40f74b };
                    ...
                    if (this.isNode()) {
                        ...
                        const { url: _0x5838e9, ..._0x4db42f } = _0x46cad7,
                            _0x527bb1 = { followRedirect: false };
                        this.instance = this.got.extend(_0x527bb1);
                        this.instance[_0x30ed81](_0x5838e9, _0x4db42f).then(_0x5339a9 => {
                            const { statusCode: _0x3bc338, request: _0x576247, headers: _0x6e3fd4, body: _0x1a837a } = _0x5339a9,
                                _0x420bc3 = { statusCode: _0x3bc338, headers: _0x6e3fd4, body: _0x1a837a };
        ...
        msg(_0x281b91 = t, _0x2a5e45 = "", _0x441be7 = "", _0xd75caf) {
            const _0x3c126f = _0xf16ff0 => {
                ...
                if ("string" == typeof _0xf16ff0) {
                    return this.isLoon() ? _0xf16ff0 : this.isQuanX() ? { "open-url": _0xf16ff0 } : this.isSurge() ? { url: _0xf16ff0 } : void 0;
                }
